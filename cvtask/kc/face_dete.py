...
def get_jetson_gstreamer_source(capture_width=1280, capture_height=720, display_width=1280, display_height=720, framerate=40, flip_method=0):
    """
...
def main_loop():
    ...
    if USING_RPI_CAMERA_MODULE:
        ...
        video_capture = cv2.VideoCapture(0) # TODO
