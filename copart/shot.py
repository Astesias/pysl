...
class ScreenShotToolBar(QToolBar):
    ...
    def __init__(self, god):
        ...
        self._at_ellipse = QAction(QIcon(r"img/sys/ellipse.png"), '圆形', self, triggered=self.beforeDrawEllipse)
        ...
        self.addAction(QAction(QIcon(r"img/chat/download.png"), '确定', self, triggered=lambda: self.beforeSave('local')))
...
class ScreenShotWidget(QWidget):
    ...
    def save2Local(self):
        ...
        global FILEPATH
        from pysl import truepath
        filePath=truepath(__file__,FILEPATH,'1.jpg')
        print(filePath)
        if filePath:
            print(self.screenArea.centerPhysicalPixmap().save(filePath, quality=100))
            self.close()
